...
/*			blackTemplate.addData(YtPlatform.PLATFORM_QQ, shareData);
			...
			blackTemplate.addData(YtPlatform.PLATFORM_TENCENTWEIBO, shareData);
			blackTemplate.addData(YtPlatform.PLATFORM_WECHAT, shareData);
			blackTemplate.addData(YtPlatform.PLATFORM_WECHATMOMENTS, shareData);
			blackTemplate.addData(YtPlatform.PLATFORM_MESSAGE, shareData);
			blackTemplate.addData(YtPlatform.PLATFORM_EMAIL, shareData);
			blackTemplate.addData(YtPlatform.PLATFORM_MORE_SHARE, shareData);*/
		...
		case R.id.list_bt:
			...
			contentshareData.setTitle("友推分享1234567890");
...
/*			whiteTemplate.addData(YtPlatform.PLATFORM_QQ, contentshareData);
		...
		case R.id.main_sinashare_imageview:
			...
			//shareData.setTarget_url("http://web.jianzhimao.com/webapp/61/ptcat61.html");
